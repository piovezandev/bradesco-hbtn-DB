...
public class MongoDBConnection {
    ...
    private static final String USERNAME = "alanpiovezan_db_user";
    private static final String PASSWORD = "cmvz2MHocZfVc57U";
    private static final String CLUSTER_URL = "cluster0.ibj7ebh.mongodb.net"; // Substitua pelo seu cluster se for diferente
